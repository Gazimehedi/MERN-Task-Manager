            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-10 center-screen">
                        <div className="card animated fadeIn w-100 p-2">
                                ...
                                <div className="container-fluid m-0 p-0">
                                    <div className="row m-0 p-0">
                                        ...
                                        <div className="col-md-4 p-2">
                                            ...
                                            <input ref={(input)=>firstNameRef=input} type="text" className="form-control animated fadeInUp" placeholder="First Nsme" />
                                        </div>
                                        <div className="col-md-4 p-2">
                                    ...
                                    <div className="row m-0 mt-1 p-0">
                                        <div className="col-md-4 p-2">
                                            <button onClick={onRegistration} className="btn btn-primary mt-3 float-end w-100 animated fadeInUp">Complete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
